...
export const repositories = {
  ...
  routes: new RouteRepository('routes', [
    { id: 'route-1', name: '서울-인천-오전-출근', startLocation: '서울', endLocation: '인천', distance: 35, estimatedTime: 70, baseRate: 80000, status: 'active', weekdayMask: 62, shiftType: 'day', timeSlot: 'am', commuteType: 'goWork', baseAllowanceAmount: 80000, effectiveFrom: now().slice(0, 10) },
  ]),
